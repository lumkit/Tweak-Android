...
our %config = (
    ...
    "perlargv" => [
        ...
        "-D__ANDROID_API__=21",
        "-fPIC",
        "--prefix=/home/lumkit/my_work/all/openssl/x86_64"
    ],
    "perlenv" => {
        "AR" => undef,
        "BUILDFILE" => undef,
...
unless (caller) {
    ...
    use lib '/home/lumkit/my_work/all/openssl-3.3.0/util/perl';
    use OpenSSL::fallback '/home/lumkit/my_work/all/openssl-3.3.0/external/perl/MODULES.txt';
    ...
    if (scalar @ARGV == 0) {
        ...
        use lib '.';
        use lib '/home/lumkit/my_work/all/openssl-3.3.0/Configurations';
        use gentemplate;
